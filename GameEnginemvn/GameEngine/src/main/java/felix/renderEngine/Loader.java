...
//        try(var resStream = Loader.class.getResourceAsStream(resourceName)){
//
//    }

    public int loadTextureResource(String fileName)  {
        Texture texture = null;
        try(var resStream = Loader.class.getResourceAsStream("/res/" +fileName +".png")){

            texture = TextureLoader.getTexture("PNG", resStream);
